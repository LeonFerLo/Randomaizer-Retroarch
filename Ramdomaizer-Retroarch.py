...
CORE_MAP = {
    ...
    '.unf': 'nestopia_libretro.dll',
    '.unif': 'nestopia_libretro.dll',
    '.sfc': 'snes9x_libretro.dll',
    '.smc': 'snes9x_libretro.dll',
    '.fig': 'snes9x_libretro.dll',
    '.swc': 'snes9x_libretro.dll',
    ...
    '.cue': 'beetle_psx_libretro.dll',
    '.bin': 'beetle_psx_libretro.dll',
    '.chd': 'beetle_psx_libretro.dll',
    '.pbp': 'beetle_psx_libretro.dll',
    '.iso': 'ppsspp_libretro.dll',
    '.cso': 'ppsspp_libretro.dll',
    '.a26': 'stella_libretro.dll',
    '.a78': 'prosystem_libretro.dll',
    '.lnx': 'handy_libretro.dll',
    '.j64': 'virtualjaguar_libretro.dll',
    '.ws': 'beetle_cygne_libretro.dll',
    '.wsc': 'beetle_cygne_libretro.dll',
    '.pce': 'beetle_pce_fast_libretro.dll',
    '.d64': 'vice_x64_libretro.dll',
    '.t64': 'vice_x64_libretro.dll',
    '.prg': 'vice_x64_libretro.dll',
    '.crt': 'vice_x64_libretro.dll',
    '.tap': 'vice_x64_libretro.dll',
    '.g64': 'vice_x64_libretro.dll',
    '.exe': 'dosbox_libretro.dll',
    '.bat': 'dosbox_libretro.dll',
    '.com': 'dosbox_libretro.dll',
    '.wad': 'prboom_libretro.dll',
    '.zip': 'mame2003_plus_libretro.dll',
    '.7z': 'mame2003_plus_libretro.dll'
}
